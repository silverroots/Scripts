...
export PATH=$HOME/Scripts:$HOME/bin:/tools/bin:/usr/local/bin:/opt/local/sbin:/opt/local/bin:/bin:/usr/sbin:/sbin:/usr/bin:$PATH

# Path to your oh-my-zsh installation.
export ZSH="/Users/katrawalkar/.oh-my-zsh"

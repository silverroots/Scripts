...
export PATH=/opt/local/bin:/opt/local/sbin:/usr/local/bin:/bin:/usr/sbin:/sbin:/usr/bin:/tools/android/android-ndk:/tools/android/android-sdk/tools:/tools/android/android-sdk/platform-tools:/tools/android/bin:$HOME/Scripts:/usr/local/go/bin:/tools/bin:$PATH
